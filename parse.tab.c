...
{
       0,    19,    19,    20,    23,    31,    93,   102,   111,   122,
     133,   151,   162,   176
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'|'", "'^'", "'&'", "$accept", "Program", "Line", "Expr0", "Expr1",
  "Expr2", "Expr3", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,    46,   126,    40,    41,   124,    94,
      38
};
# endif
...
{
      15,    -5,    15,    15,     2,    15,    -1,    -4,     5,    -5,
      -5,    -5,     8,    15,     0,    -5,    -5,    -5,    -5,    15,
      -4,    15,    -4,    -4
};
...
{
       7,     8,     9,    11,    12,    13,    14,    12,    13,    14,
      21,    20,    18,    12,    13,    14,    19,    22,     1,    23,
       2,     3,    10
};

static const yytype_uint8 yycheck[] =
{
       2,     3,     0,     4,     8,     9,    10,     8,     9,    10,
      10,    13,     7,     8,     9,    10,     8,    19,     3,    21,
       5,     6,     5
};
...
{
       0,     3,     5,     6,    12,    13,    14,    14,    14,     0,
      12,     4,     8,     9,    10,    15,    16,    17,     7,     8,
      14,    10,    14,    14
};
...
#line 31 "parse.y" /* yacc.c:1646  */
    { if ((yyvsp[0].boolType).op_or) {
			  ...
			  } else if ((yyvsp[0].boolType).op_and) {
			      // printf("t_flag_1: %d, f_flag_1: %d\n", $1.t, $1.f);
                              // printf("t_flag_2: %d, f_flag_2: %d\n", $2.t, $2.f);
                              if ((yyvsp[-1].boolType).t) {
                                if ((yyvsp[0].boolType).t) {
                          ...
                          } else if ((yyvsp[0].boolType).op_xor) {
                              if ((yyvsp[-1].boolType).t) {
                                if ((yyvsp[0].boolType).t) {
                                  (yyval.boolType).t = 0;
                                  (yyval.boolType).f = 1;
...
#line 133 "parse.y" /* yacc.c:1646  */
    { if ((yyvsp[0].boolType).op_and) {
			    (yyval.boolType).op_and = 1;
			  } else if ((yyvsp[0].boolType).op_or) {
			      (yyval.boolType).op_or = 1;
			  } else {
			      (yyval.boolType).op_xor = 1;
			  }
